...
export default function UpdatePasswordPage() {
  ...
  useEffect(() => {
    // Verificar se estamos em um ambiente de navegador e se temos um hash na URL
    if (typeof window !== 'undefined') {
      // O token está no formato #access_token=xxx&refresh_token=yyy&...
      const hash = window.location.hash;
      if (hash) {
        // Se temos um hash, assumimos que é um token válido por enquanto
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Tenta atualizar a senha usando o token da URL
      ...
      const errorMsg = err.message || 'Ocorreu um erro ao atualizar a senha';
      ...
      >
        ...
        >
            ...
            <>
              {!hasValidHash ? (
                <Alert className="border border-red-200 bg-red-50/50 text-red-800">
                  ...
                  <AlertDescription>
                    Link de recuperação inválido ou expirado. Por favor, solicite um novo link para redefinir sua senha.
                  </AlertDescription>
                </Alert>
              ) : (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className={`pl-10 bg-blue-50/50 border-blue-100 py-5 rounded-lg transition-all duration-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 ${error && password === '' ? 'border-red-300 bg-red-50/50 focus:ring-red-500/20 focus:border-red-400' : ''}`}
                        required
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className={`pl-10 bg-blue-50/50 border-blue-100 py-5 rounded-lg transition-all duration-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 ${error && confirmPassword === '' ? 'border-red-300 bg-red-50/50 focus:ring-red-500/20 focus:border-red-400' : ''}`}
                        required
                      />
                      <div className="absolute inset-y-0 left-3 flex items-center text-gray-400 pointer-events-none">
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24">
          ...
          <div className="text-center w-full text-sm text-gray-500 mt-6">
            ...
            <a href="/" onClick={(e) => { e.preventDefault(); router.push('/'); }} className="font-medium text-blue-600 hover:text-blue-800 transition-colors">
              Voltar para o login
            </a>
          </div>
        </motion.div>
