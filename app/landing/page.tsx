            ...
            <div className="overflow-hidden">
              <div className="flex items-stretch space-x-6 pb-12 px-8 overflow-x-auto snap-x snap-mandatory scrollbar-hide">
                ...
                <div className="testimonial-card min-w-[280px] w-full md:w-[340px] max-w-[380px] flex-shrink-0 p-6 rounded-2xl border border-gray-800 bg-gradient-to-b from-gray-900/60 to-gray-950/60 backdrop-blur-md hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 snap-start flex flex-col h-auto">
                  ...
                  <div className="flex items-center">
                    <div className="flex-shrink-0 mr-4">
                      <img src="/images/dropfy/avatar-lucca.png" alt="Foto de perfil" className="w-12 h-12 rounded-full border-2 border-blue-500 object-cover" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-white">Lucca Maccario</h4>
                      <p className="text-sm text-blue-400">CEO & Founder</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="pricing-card rounded-2xl border border-yellow-500/30 overflow-hidden transition-all duration-300 hover:border-yellow-500/80 hover:shadow-xl hover:shadow-yellow-500/10 hover:-translate-y-2 bg-gradient-to-b from-gray-900/80 to-gray-950/80 backdrop-blur-sm relative z-10 lg:scale-110">
              <div className="absolute -top-5 inset-x-0 flex justify-center">
                <div className="bg-gradient-to-r from-yellow-600 to-yellow-400 text-gray-900 px-6 py-2 rounded-full font-bold text-sm shadow-lg shadow-yellow-500/20">
                  MAIS POPULAR
                </div>
              </div>
